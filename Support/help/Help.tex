...
\begin{itemize}
    ...
    \item If you drop a source code file into your document, then TextMate creates a new \texttt{lstinputlisting} command referencing the dropped file. \texttt{lstinputlisting} is part of the package \texttt{listings}, so make sure that you include said package via \verb|\usepackage{listings}|.
